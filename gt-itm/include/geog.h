...
//#define BIGINT		LONG_MAX  //run on 32bits?
#define BIGINT          INT_MAX //run on 64 bits
//#define randfrac()	(gb_next_rand() / (double) LONG_MAX) //run on 32bits?
#define randfrac()	(gb_next_rand() / (double) INT_MAX) //run on 64 bits
